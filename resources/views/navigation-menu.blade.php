            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('orders') }}"
                        :active="request()->routeIs('orders') ||request()->routeIs('order.show')">
                        {{ __('Orders') }}
                    </x-jet-nav-link>
                    ...
                    <x-jet-nav-link href="{{ route('money.invoice') }}"
                        :active="request()->routeIs('money.invoice') || request()->routeIs('money.invoice.list') ">
                        {{ __('Money') }}
                    </x-jet-nav-link>
